      ...
      {isLoaded ? (
        <Popover>
          <PopoverTrigger asChild>
            <div className="flex w-1/3 cursor-pointer flex-row items-center justify-between rounded-lg py-2 text-sm text-primary-dark sm:w-1/4">
              ...
              {value !== '' && (
                <Icons.close
                  className="h-6 w-6 rounded-lg p-1 hover:bg-primary"
                  onClick={() => {
                    setValue('');
                    onSelectAddress('');
                  }}
